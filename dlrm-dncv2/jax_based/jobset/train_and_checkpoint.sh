...
export FILE_PATTERN='gs://zyc_dlrm/dataset/tb_tf_record_train_val/train/day_*/*'
export NUM_STEPS=28000
export CHECKPOINT_INTERVAL=1500
export EVAL_INTERVAL=1500
export EVAL_FILE_PATTERN='gs://zyc_dlrm/dataset/tb_tf_record_train_val/eval/day_*/*'
