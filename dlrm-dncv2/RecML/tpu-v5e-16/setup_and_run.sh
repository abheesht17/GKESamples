...
# Set Env variables
export TPU_NAME="chavoshi-dlrm-dnc-v2-benchmark-tpu-v5p-16"
...
# tpu setup commands 
gcloud alpha compute tpus tpu-vm create ${TPU_NAME}   --zone=${ZONE}   --accelerator-type=v5p-16   --version=v2-alpha-tpuv5   --project=${PROJECT}   --metadata=enable-oslogin=TRUE   --scopes=https://www.googleapis.com/auth/cloud
-platform 
